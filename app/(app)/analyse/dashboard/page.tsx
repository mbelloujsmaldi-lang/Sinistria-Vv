...
// Analyse : tableau de bord (Sprint 16) — tout profil actif, comme le
// Registre. proxy.ts a déjà refusé tout compte inactif ou sans profil
// avant d'atteindre cette page ; pas de garde de rôle supplémentaire.
export default async function PageAnalyseDashboard() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <h1 className="mb-1 text-lg font-medium text-ink">Analyse</h1>
      <p className="mb-6 text-sm text-slate">
        Tableau de bord — une ligne par dossier (la révision la plus récente), indicateurs de valeur
        calculés sur les dossiers validés uniquement.
      </p>
